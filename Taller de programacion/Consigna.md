...
![alt text](<Fotos md/image.png>)


### Conexion a la red
Los pasos para conectarse a la red estan explicados en la guia de desarrollo [P2P network](https://developer.bitcoin.org/devguide/p2p_network.html). Durante todo el desarrollo del proyecto utilizaremos la red de pruebas de Bitcoin: 'testnet'. Se debera tener en cuenta las siguientes consideraciones:
...
5. Alerts: estan discontinuadas y en caso de recibir una de ellas podemos ignorar el mensaje.
...
Importante: luego de realizada una transaccion podremos verificar que la misma se genero correctamente mediante el uso de un blockchain explorer de testnet, por ejemplo [bitaps](bitaps)
...
![alt text](<Fotos md/image-2.png>)

### Crear transacciones

![alt text](<Fotos md/image-3.png>)

### Ver transacciones

![alt text](<Fotos md/image-4.png>)
